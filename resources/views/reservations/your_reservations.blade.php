                                ...
                                <div class="col-md-8">
                                    ...
                                    <span>
                                        <a href="{{ route('users.show', $reservation->user) }}">
                                            @if ($reservation->room->user->socialAccount)
                                                <img src="{{ $reservation->room->user->socialAccount->image }}" class="rounded-circle" width="28px">
                                            @else
                                                <img src="{{ $reservation->room->user->gravatar(28) }}" class="rounded-circle">
                                            @endif
